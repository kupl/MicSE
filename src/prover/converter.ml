...
=fun e t -> begin
  ...
  | E_car v -> VE_uni_op (VE_car, (Vlang.create_exp_var v t))
  | E_cdr v -> VE_uni_op (VE_cdr, (Vlang.create_exp_var v t))
  | E_abs v -> VE_uni_op (VE_abs, (Vlang.create_exp_var v t))
  | E_neg v -> VE_uni_op (VE_neg, (Vlang.create_exp_var v t))
  | E_not v -> VE_uni_op (VE_not, (Vlang.create_exp_var v t))
  | E_add (v1, v2) -> VE_bin_op (VE_add, (Vlang.create_exp_var v1 t), (Vlang.create_exp_var v2 t))
  | E_sub (v1, v2) -> VE_bin_op (VE_sub, (Vlang.create_exp_var v1 t), (Vlang.create_exp_var v2 t))
  | E_mul (v1, v2) -> VE_bin_op (VE_mul, (Vlang.create_exp_var v1 t), (Vlang.create_exp_var v2 t))
  | E_ediv (v1, v2) -> VE_bin_op (VE_ediv, (Vlang.create_exp_var v1 t), (Vlang.create_exp_var v2 t))
  | E_div (v1, v2) -> VE_bin_op (VE_div, (Vlang.create_exp_var v1 t), (Vlang.create_exp_var v2 t))
  | E_mod (v1, v2) -> VE_bin_op (VE_mod, (Vlang.create_exp_var v1 t), (Vlang.create_exp_var v2 t))
  | E_shiftL (v1, v2) -> VE_bin_op (VE_lsl, (Vlang.create_exp_var v1 t), (Vlang.create_exp_var v2 t))
  | E_shiftR (v1, v2) -> VE_bin_op (VE_lsr, (Vlang.create_exp_var v1 t), (Vlang.create_exp_var v2 t))
  | E_and (v1, v2) -> VE_bin_op (VE_and, (Vlang.create_exp_var v1 t), (Vlang.create_exp_var v2 t))
  | E_or (v1, v2) -> VE_bin_op (VE_or, (Vlang.create_exp_var v1 t), (Vlang.create_exp_var v2 t))
  | E_xor (v1, v2) -> VE_bin_op (VE_xor, (Vlang.create_exp_var v1 t), (Vlang.create_exp_var v2 t))
  | E_eq v -> VE_uni_op (VE_eq, (Vlang.create_exp_var v t))
  | E_neq v -> VE_uni_op (VE_neq, (Vlang.create_exp_var v t))
  | E_lt v -> VE_uni_op (VE_lt, (Vlang.create_exp_var v t))
  | E_gt v -> VE_uni_op (VE_gt, (Vlang.create_exp_var v t))
  | E_leq v -> VE_uni_op (VE_leq, (Vlang.create_exp_var v t))
  | E_geq v -> VE_uni_op (VE_geq, (Vlang.create_exp_var v t))
  | E_compare (v1, v2) -> VE_bin_op (VE_cmp, (Vlang.create_exp_var v1 t), (Vlang.create_exp_var v2 t))
  | E_cons (v1, v2) -> VE_bin_op (VE_cons, (Vlang.create_exp_var v1 t), (Vlang.create_exp_var v2 t))
  | E_operation o -> begin
      match o with
  ...
  | E_cast v -> VE_uni_op (VE_cast, (Vlang.create_exp_var v t))
  | E_concat (v1, v2) -> VE_bin_op (VE_concat, (Vlang.create_exp_var v1 t), (Vlang.create_exp_var v2 t))
  | E_concat_list v -> VE_uni_op (VE_concat, (Vlang.create_exp_var v t))
  | E_slice (v1, v2, v3) -> VE_ter_op (VE_slice, (Vlang.create_exp_var v1 t), (Vlang.create_exp_var v2 t), (Vlang.create_exp_var v3 t))
  | E_pack v -> VE_uni_op (VE_pack, (Vlang.create_exp_var v t))
  | E_unpack (_, v) -> VE_uni_op (VE_unpack, (Vlang.create_exp_var v t))
  | E_self -> VE_nul_op (VE_self)
  | E_contract_of_address v -> VE_uni_op (VE_contract, (Vlang.create_exp_var v t))
  | E_implicit_account v -> VE_uni_op (VE_account, (Vlang.create_exp_var v t))
  | E_now -> VE_nul_op (VE_now)
  | E_amount -> VE_nul_op (VE_amount)
  | E_balance -> VE_nul_op (VE_balance)
  | E_check_signature (v1, v2, v3) -> VE_ter_op (VE_check_signature, (Vlang.create_exp_var v1 t), (Vlang.create_exp_var v2 t), (Vlang.create_exp_var v3 t))
  | E_blake2b v -> VE_uni_op (VE_blake2b, (Vlang.create_exp_var v t))
  | E_sha256 v -> VE_uni_op (VE_sha256, (Vlang.create_exp_var v t))
  | E_sha512 v -> VE_uni_op (VE_sha512, (Vlang.create_exp_var v t))
  | E_hash_key v -> VE_uni_op (VE_hash_key, (Vlang.create_exp_var v t))
  | E_steps_to_quota -> VE_nul_op (VE_steps_to_quota)
  | E_source -> VE_nul_op (VE_source)
  | E_sender -> VE_nul_op (VE_sender)
  | E_address_of_contract v -> VE_uni_op (VE_address, (Vlang.create_exp_var v t))
  | E_create_contract_address _ -> VE_operation (VE_origination)
  | E_unlift_option v -> VE_uni_op (VE_un_opt, (Vlang.create_exp_var v t))
  | E_unlift_or v -> VE_uni_op (VE_un_or, (Vlang.create_exp_var v t))
  | E_hd v -> VE_uni_op (VE_hd, (Vlang.create_exp_var v t))
  | E_tl v -> VE_uni_op (VE_tl, (Vlang.create_exp_var v t))
  | E_size v -> VE_uni_op (VE_size, (Vlang.create_exp_var v t))
  | E_isnat v -> VE_uni_op (VE_isnat, (Vlang.create_exp_var v t))
  | E_int_of_nat v -> VE_uni_op (VE_int, (Vlang.create_exp_var v t))
  | E_chain_id -> VE_nul_op (VE_chain_id)
  | E_create_account_address _ -> VE_operation (VE_origination)
  | E_lambda (_, _, _) -> VE_lambda
  | E_exec (v1, v2) -> VE_bin_op (VE_exec, (Vlang.create_exp_var v1 t), (Vlang.create_exp_var v2 t))
  | E_dup v -> (Vlang.create_exp_var v t)
  | E_nil _ -> VE_list ([], t)
  | E_empty_set _ -> VE_list ([], t)
  | E_empty_map _ -> VE_list ([], t)
  | E_empty_big_map _ -> VE_list ([], t)
  | E_append (v1, v2) -> VE_bin_op (VE_append, (Vlang.create_exp_var v1 t), (Vlang.create_exp_var v2 t))
