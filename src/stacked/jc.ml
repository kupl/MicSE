...
let cs_mich_t_cc = cs_mich_t ^ "_cc"
let cs_mich_v_cc = cs_mich_v ^ "_cc"
let cs_mich_i_cc = cs_mich_i ^ "_cc"
let cs_mich_cut_category = "mich_cut_category"
let cs_mich_cut_info = "mich_cut_info"