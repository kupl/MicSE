...
val inv_initial_fmla : Tz.sym_state -> Tz.mich_v Tz.cc -> Tz.mich_f Core.Set.Poly.t -> Tz.mich_f
val inv_constraint_fmla : Tz.sym_state -> (Tz.mich_f Core.Set.Poly.t) -> Tz.mich_f
